...
source_url: https://iclr.cc/virtual/2026/oral/10006584
paper_pdf_url: https://arxiv.org/pdf/2509.15221v2
venue: ICLR
year: 2026
...
GUI Understanding Online Benchmarks (Desktop & Mobile & Web) GUI Grounding

MMBench-GUI L1-Hard Screenspot-Pro WindowsAgentArena WebArena-Lite-v2
...
arXiv:2509.15221v2 [cs.CV] 19 Sep 2025

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 1](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-001-figure-08.svg)
...
Multi-Platform Environments iOS Android iPadOS Web Linux (Ubuntu) macOS Windows
...
![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-17.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-22.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-23.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-25.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-26.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-27.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-28.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-29.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 4](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-004-figure-30.svg)
...
Data source Platform Understanding Grounding Trajectories Collection
...
1https://github.com/SeleniumHQ/selenium 2https://github.com/AutoHotkey/AutoHotkey
...
<operation> Click on the YouTube search bar and write "Python Tutorial" to find programming tutorials. </operation> <action> click(943, 168)\nwrite(“Python Tutorial”) </action>
...
Easy Level GPT-4o (2024) 62.5 67.9 62.4 58.5 56.4 58.5 60.2 Claude-3.5 (2024a) 41.3 50.0 41.6 42.0 39.0 41.8 41.5 Claude-3.7 (2025) 34.7 49.1 39.4 42.8 37.5 40.8 39.1 Qwen-Max-VL (2023) 69.1 72.5 69.9 70.8 63.1 69.5 68.2 Qwen2.5-VL-72B (2025) 65.9 75.2 73.0 67.2 58.1 72.1 67.0 UI-TARS-72B-DPO (2025) 41.6 28.5 35.2 31.1 52.3 35.3 40.2 InternVL3-72B (2025) 74.7 78.7 79.2 83.6 80.1 81.2 79.2 GUI-Owl-7B (2025) 83.0 84.5 85.6 82.6 83.3 88.1 84.5 GUI-Owl-32B (2025) 93.7 89.3 93.3 95.7 90.5 94.1 92.8 ScaleCUA-3B 86.4 83.5 79.9 85.4 80.3 87.4 83.6 ScaleCUA-7B 89.5 86.9 89.1 86.2 87.0 90.1 88.4 ScaleCUA-32B 93.4 91.7 94.3 93.1 90.5 92.3 92.5 Medium Level GPT-4o (2024) 56.3 63.1 59.7 54.1 57.7 55.0 57.2 Claude-3.5 (2024a) 39.3 47.6 46.0 44.6 42.0 34.33 41.26 Claude-3.7 (2025) 39.3 39.2 42.3 39.5 36.1 36.2 38.4 Qwen-Max-VL (2023) 63.4 73.9 66.9 68.0 63.7 64.6 65.4 Qwen2.5-VL-72B (2025) 66.3 72.7 72.6 59.3 66.2 68.2 67.5 UI-TARS-72B-DPO (2025) 38.8 41.6 37.1 41.7 54.7 31.6 41.8 InternVL3-72B (2025) 71.5 78.6 79.9 78.4 81.4 78.7 77.9 GUI-Owl-7B (2025) 88.9 88.1 91.2 84.4 85.3 83.6 86.9 GUI-Owl-32B (2025) 94.1 84.5 95.9 87.8 92.8 88.6 91.7 ScaleCUA-3B 91.8 78.5 88.7 74.8 88.6 79.5 85.6 ScaleCUA-7B 93.6 91.7 93.4 84.3 89.6 85.8 90.1 ScaleCUA-32B 95.1 89.4 96.3 92.2 92.6 87.2 92.5 Hard Level GPT-4o (2024) 60.7 60.4 52.4 45.3 50.9 50.8 53.5 Claude-3.5 (2024a) 37.40 42.70 34.07 40.86 36.96 38.1 37.6 Claude-3.7 (2025) 33.0 34.5 32.0 39.2 37.0 38.9 35.7 Qwen-Max-VL (2023) 66.6 67.6 65.8 60.2 58.8 65.3 63.7 Qwen2.5-VL-72B (2025) 70.7 68.9 71.0 57.6 53.9 68.1 64.6 UI-TARS-72B-DPO (2025) 31.5 35.9 24.2 36.3 58.1 19.9 35.8 InternVL3-72B (2025) 75.1 77.4 76.2 70.4 75.7 78.1 75.7 GUI-Owl-7B (2025) 87.8 96.4 94.3 87.8 88.9 94.1 90.9 GUI-Owl-32B (2025) 93.3 95.2 95.9 92.2 95.4 92.69 94.2 ScaleCUA-3B 92.3 89.4 93.8 85.3 88.3 88.6 89.9 ScaleCUA-7B 91.9 91.9 94.9 89.6 92.9 91.4 92.3 ScaleCUA-32B 93.0 96.5 96.4 93.1 94.5 94.0 94.4
...
Mobile Desktop Web Avg Text Icon/Widget Text Icon/Widget Text Icon/Widget
...
Agent Model Development Creative CAD Scientific Office OS Avg Text Icon Avg Text Icon Avg Text Icon Avg Text Icon Avg Text Icon Avg Text Icon Avg
...
ScaleCUA-3B 57.8 18.6 38.8 42.9 16.8 32.0 54.3 28.1 47.9 64.6 35.5 52.0 66.7 37.7 53.9 31.8 16.9 25.0 42.3 ScaleCUA-7B 66.2 20.7 44.1 56.6 20.3 41.3 54.8 21.9 46.7 77.1 24.5 54.3 74.0 45.3 67.4 49.5 18.0 35.2 47.9 ScaleCUA-32B 75.3 35.2 55.8 73.2 30.8 55.4 60.4 39.1 55.2 76.4 46.4 63.4 81.4 49.1 73.9 63.6 41.6 53.6 59.2 surpassing all open VLMs. Even the lightweight ScaleCUA-3B delivers 89.2%, outperforming Qwen2.5-VL-7B by +0.4% despite using far fewer parameters. On the more challenging ScreenSpot- Pro, ScaleCUA-32B again dominates, achieving 59.2% overall and delivering strong accuracy across diverse domains such as Creative software, CAD, and office applications.
...
Mobile Ubuntu Windows MacOS Web (AndroidWorld) (OSWorld) (WindowsAgentArena) (MacOSArena) (WebArena-Lite-v2)
...
Training Data + WS OSWorld WAL-v2

Qwen2.5VL-3B public-only ✗ 7.9 8.4 ✓ 8.5 14.3
...
Qwen2.5VL-3B Norm. 37.9 Raw 42.3

(d) The ablation on the maximum resolution during training.

## Model

Res. SS-Pro OSWOrld-G OSWorld AW

Qwen2.5VL-3B 1080P 42.3 54.3 12.4 23.3 2K 45.5 52.5 11.2 13.4

(b) Direct-Action vs. Reasoned-Action (a) Test-time resolution in GUI grounding (c) Performance curve when scaling our data (c) General data used in training
...
![Figure extracted from page 14](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-014-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 14](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-014-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 14](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-014-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 14](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-014-figure-04.svg)
...
Sonnet Anthropic. Model card addendum: Claude 3.5 haiku and upgraded claude 3.5 sonnet, 2024b.

URL https://api.semanticscholar.org/CorpusID:273639283.

Sonnet Anthropic. Claude 3.7 sonnet system card, 2025. URL https://www.anthropic.

com/news/claude-3-7-sonnet.

Chongyang Bai, Xiaoxue Zang, Ying Xu, Srinivas Sunkara, Abhinav Rastogi, Jindong Chen, and

Blaise Ag¨uera y Arcas. Uibert: Learning generic multimodal representations for UI understanding. In Proceedings of the Thirtieth International Joint Conference on Artificial Intelligence, 2021.
...
Lu, Justin Wagle, Kazuhito Koishida, Arthur Bucker, et al. Windows agent arena: Evaluating multi-modal os agents at scale. arXiv preprint arXiv:2409.08264, 2024.
...
Dongping Chen, Yue Huang, Siyuan Wu, Jingyu Tang, Huichi Zhou, Qihui Zhang, Zhigang He, Yilin

Bai, Chujie Gao, Liuyi Chen, et al. Gui-world: A video benchmark and dataset for multimodal gui-oriented understanding. In ICLR, 2025a.

Wentong Chen, Junbo Cui, Jinyi Hu, Yujia Qin, Junjie Fang, Yue Zhao, Chongyi Wang, Jun Liu,

Guirong Chen, Yupeng Huo, et al. Guicourse: From general vision language models to versatile gui agents. arXiv preprint arXiv:2406.11317, 2024a.

Xuetian Chen, Yinghao Chen, Xinfeng Yuan, Zhuo Peng, Lu Chen, Yuekeng Li, Zhoujia Zhang,

Yingqian Huang, Leyan Huang, Jiaqing Liang, et al. Os-map: How far can computer-using agents go in breadth and depth? arXiv preprint arXiv:2507.19132, 2025b.

Zhe Chen, Weiyun Wang, Yue Cao, Yangzhou Liu, Zhangwei Gao, Erfei Cui, Jinguo Zhu, Shenglong

Ye, Hao Tian, Zhaoyang Liu, et al. Expanding performance boundaries of open-source multimodal models with model, data, and test-time scaling. arXiv preprint arXiv:2412.05271, 2024b.

Zhe Chen, Jiannan Wu, Wenhai Wang, Weijie Su, Guo Chen, Sen Xing, Muyan Zhong, Qinglong

Zhang, Xizhou Zhu, Lewei Lu, et al. Internvl: Scaling up vision foundation models and aligning for generic visual-linguistic tasks. In Proceedings of the IEEE/CVF conference on computer vision and pattern recognition, pp. 24185–24198, 2024c.
...
Nichols, and Ranjitha Kumar. Rico: A mobile app dataset for building data-driven design applications. In Proceedings of the 30th annual ACM symposium on user interface software and technology, pp. 845–854, 2017.
...
Steven Ka Shing Yau, Zijuan Lin, Liyang Zhou, et al. Metagpt: Meta programming for multi-agent collaborative framework. arXiv preprint arXiv:2308.00352, 3(4):6, 2023.

Wenyi Hong, Weihan Wang, Qingsong Lv, Jiazheng Xu, Wenmeng Yu, Junhui Ji, Yan Wang, Zihan

Wang, Yuxiao Dong, Ming Ding, et al. Cogagent: A visual language model for gui agents. In Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition, pp. 14281–14290, 2024.

Wenyi Hong, Wenmeng Yu, Xiaotao Gu, Guo Wang, Guobing Gan, Haomiao Tang, Jiale Cheng,

Ji Qi, Junhui Ji, Lihang Pan, et al. Glm-4.1 v-thinking: Towards versatile multimodal reasoning with scalable reinforcement learning. arXiv preprint arXiv:2507.01006, 2025.
...
Neubig, Shuyan Zhou, Ruslan Salakhutdinov, and Daniel Fried. Visualwebarena: Evaluating multimodal agents on realistic visual web tasks. arXiv preprint arXiv:2401.13649, 2024.
...
Hanyu Lai, Xiao Liu, Yanxiao Zhao, Han Xu, Hanchen Zhang, Bohao Jing, Yanyu Ren, Shuntian

Yao, Yuxiao Dong, and Jie Tang. Computerrl: Scaling end-to-end online reinforcement learning for computer use agents. arXiv preprint arXiv:2508.14040, 2025.

Guohao Li, Hasan Hammoud, Hani Itani, Dmitrii Khizbullin, and Bernard Ghanem. Camel: Com- municative agents for” mind” exploration of large language model society. Advances in Neural Information Processing Systems, 36:51991–52008, 2023.
...
Tat-Seng Chua. Screenspot-pro: Gui grounding for professional high-resolution computer use. arXiv preprint arXiv:2504.07981, 2025.
...
Wei Li, William E Bishop, Alice Li, Christopher Rawles, Folawiyo Campbell-Ajala, Divya Tyama- gundlu, and Oriana Riva. On the effects of data scale on ui control agents. Advances in Neural Information Processing Systems, 37:92130–92154, 2024b.

Yang Li, Jiacong He, Xin Zhou, Yuan Zhang, and Jason Baldridge. Mapping natural language instructions to mobile UI action sequences. In Proceedings of the 58th Annual Meeting of the Association for Computational Linguistics. Association for Computational Linguistics, 2020a.
...
Lijuan Wang, and Mike Zheng Shou. Showui: One vision-language-action model for gui visual agent, 2024. URL https://arxiv.org/abs/2411.17465.

Haowei Liu, Xi Zhang, Haiyang Xu, Yuyang Wanyan, Junyang Wang, Ming Yan, Ji Zhang, Chunfeng

Yuan, Changsheng Xu, Weiming Hu, and Fei Huang. Pc-agent: A hierarchical multi-agent collaboration framework for complex task automation on pc. arXiv preprint arXiv:2502.14282, 2025a.

Xiao Liu, Tianjie Zhang, Yu Gu, Iat Long Iong, Yifan Xu, Xixuan Song, Shudan Zhang, Hanyu Lai,

Xinyi Liu, Hanlin Zhao, et al. Visualagentbench: Towards large multimodal models as visual foundation agents. arXiv preprint arXiv:2408.06327, 2024a.
...
Cheng-Lin Liu, Lianwen Jin, and Xiang Bai. Ocrbench: on the hidden mystery of ocr in large multimodal models. Science China Information Sciences, 67(12):220102, 2024b.

Pan Lu, Hritik Bansal, Tony Xia, Jiacheng Liu, Chunyuan Li, Hannaneh Hajishirzi, Hao Cheng,

Kai-Wei Chang, Michel Galley, and Jianfeng Gao. Mathvista: Evaluating mathematical reasoning of foundation models in visual contexts. arXiv preprint arXiv:2310.02255, 2023.

Quanfeng Lu, Wenqi Shao, Zitao Liu, Fanqing Meng, Boxuan Li, Botong Chen, Siyuan Huang,

Kaipeng Zhang, Yu Qiao, and Ping Luo. Gui odyssey: A comprehensive dataset for cross-app gui navigation on mobile devices. arXiv preprint arXiv:2406.08451, 2024a.
...
Guanjing Xiong, and Hongsheng Li. Ui-r1: Enhancing efficient action prediction of gui agents by reinforcement learning. arXiv preprint arXiv:2503.21620, 2025.
...
An open-domain platform for web-based agents. In Doina Precup and Yee Whye Teh (eds.), Proceedings of the 34th International Conference on Machine Learning, ICML 2017, Sydney, NSW, Australia, 6-11 August 2017, volume 70 of Proceedings of Machine Learning Research, pp. 3135–
...
Chengcheng Han, Renyu Zhu, Shuai Yuan, et al. A survey of neural code intelligence: Paradigms, advances and beyond. arXiv preprint arXiv:2403.14734, 2024a.

Qiushi Sun, Kanzhi Cheng, Zichen Ding, Chuanyang Jin, Yian Wang, Fangzhi Xu, Zhenyu Wu,

Chengyou Jia, Liheng Chen, Zhoumianze Liu, et al. Os-genesis: Automating gui agent trajectory construction via reverse task synthesis. arXiv preprint arXiv:2412.19723, 2024b.

Qiushi Sun, Zhoumianze Liu, Chang Ma, Zichen Ding, Fangzhi Xu, Zhangyue Yin, Haiteng Zhao,

Zhenyu Wu, Kanzhi Cheng, Zhaoyang Liu, et al. Scienceboard: Evaluating multimodal autonomous agents in realistic scientific workflows. arXiv preprint arXiv:2505.19897, 2025.
...
Tanzer, Damien Vincent, Zhufeng Pan, Shibo Wang, et al. Gemini 1.5: Unlocking multimodal understanding across millions of tokens of context. arXiv preprint arXiv:2403.05530, 2024.

Gemma Team, Aishwarya Kamath, Johan Ferret, Shreya Pathak, Nino Vieillard, Ramona Merhej,

Sarah Perrin, Tatiana Matejovicova, Alexandre Ram´e, Morgane Rivi`ere, et al. Gemma 3 technical report. arXiv preprint arXiv:2503.19786, 2025a.
...
Huang, Zihao Huang, Zijia Zhao, and Ziwei Chen. Kimi-VL technical report, 2025b. URL https://arxiv.org/abs/2504.07491.

Kimi Team, Angang Du, Bohong Yin, Bowei Xing, Bowen Qu, Bowen Wang, Cheng Chen, Chenlin

Zhang, Chenzhuang Du, Chu Wei, et al. Kimi-vl technical report. arXiv preprint arXiv:2504.07491, 2025c.

Junyang Wang, Haiyang Xu, Jiabo Ye, Ming Yan, Weizhou Shen, Ji Zhang, Fei Huang, and Jitao

Sang. Mobile-agent: Autonomous multi-modal mobile device agent with visual perception. arXiv preprint arXiv:2401.16158, 2024a.

Peng Wang, Shuai Bai, Sinan Tan, Shijie Wang, Zhihao Fan, Jinze Bai, Keqin Chen, Xuejing Liu,

Jialin Wang, Wenbin Ge, et al. Qwen2-vl: Enhancing vision-language model’s perception of the world at any resolution. arXiv preprint arXiv:2409.12191, 2024b.

Weiyun Wang, Zhangwei Gao, Lixin Gu, Hengjun Pu, Long Cui, Xingguang Wei, Zhaoyang Liu,

Linglin Jing, Shenglong Ye, Jie Shao, et al. Internvl3. 5: Advancing open-source multimodal models in versatility, reasoning, and efficiency. arXiv preprint arXiv:2508.18265, 2025a.
...
Qingyun Li, Xuan Dong, Zhe Chen, et al. Mmbench-gui: Hierarchical multi-platform evaluation framework for gui agents. arXiv preprint arXiv:2507.19478, 2025c.
...
Baolin Peng, Bo Qiao, Reuben Tan, et al. Gui-actor: Coordinate-free visual grounding for gui agents. arXiv preprint arXiv:2506.03143, 2025.

Qingyun Wu, Gagan Bansal, Jieyu Zhang, Yiran Wu, Beibin Li, Erkang Zhu, Li Jiang, Xiaoyun Zhang,

Shaokun Zhang, Jiale Liu, et al. Autogen: Enabling next-gen llm applications via multi-agent conversation. arXiv preprint arXiv:2308.08155, 2023b.
...
Ding, Liheng Chen, Paul Pu Liang, et al. Os-atlas: A foundation action model for generalist gui agents. arXiv preprint arXiv:2410.23218, 2024b.
...
Zhoujun Cheng, Dongchan Shin, Fangyu Lei, et al. Osworld: Benchmarking multimodal agents for open-ended tasks in real computer environments. Advances in Neural Information Processing Systems, 37:52040–52094, 2024.

Tianbao Xie, Jiaqi Deng, Xiaochuan Li, Junlin Yang, Haoyuan Wu, Jixuan Chen, Wenjing Hu,

Xinyuan Wang, Yuhui Xu, Zekun Wang, Yiheng Xu, Junli Wang, Doyen Sahoo, Tao Yu, and Caiming Xiong. Scaling computer-use grounding via user interface decomposition and synthesis, 2025. URL https://arxiv.org/abs/2505.13227.
...
Huang, Amrita Saha, Zeyuan Chen, et al. Gta1: Gui test-time scaling agent. arXiv preprint arXiv:2507.05791, 2025.

Yuhao Yang, Yue Wang, Dongxu Li, Ziyang Luo, Bei Chen, Chao Huang, and Junnan Li. Aria-ui:

Visual grounding for gui instructions. arXiv preprint arXiv:2412.16256, 2024.
...
Jiabo Ye, Xi Zhang, Haiyang Xu, Haowei Liu, Junyang Wang, Zhaoqing Zhu, Ziwei Zheng, Feiyu

Gao, Junjie Cao, Zhengxi Lu, et al. Mobile-agent-v3: Foundamental agents for gui automation. arXiv preprint arXiv:2508.15144, 2025.

Wenwen Yu, Zhibo Yang, Jianqiang Wan, Sibo Song, Jun Tang, Wenqing Cheng, Yuliang Liu, and

Xiang Bai. Omniparser v2: Structured-points-of-thought for unified visual text parsing and its generality to multimodal large language models. arXiv preprint arXiv:2502.16161, 2025.

Xinbin Yuan, Jian Zhang, Kaixin Li, Zhuoxuan Cai, Lujian Yao, Jie Chen, Enguang Wang, Qibin Hou,

Jinwei Chen, Peng-Tao Jiang, et al. Enhancing visual grounding for gui agents via self-evolutionary reinforcement learning. arXiv preprint arXiv:2505.12370, 2025.

Xiang Yue, Yuansheng Ni, Kai Zhang, Tianyu Zheng, Ruoqi Liu, Ge Zhang, Samuel Stevens, Dongfu

Jiang, Weiming Ren, Yuxuan Sun, et al. Mmmu: A massive multi-discipline multimodal understanding and reasoning benchmark for expert agi. In Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition, pp. 9556–9567, 2024.

Bofei Zhang, Zirui Shang, Zhi Gao, Wang Zhang, Rui Xie, Xiaojian Ma, Tao Yuan, Xinxiao Wu, Song-

Chun Zhu, and Qing Li. Tongui: Building generalized gui agents by learning from multimodal web tutorials. arXiv preprint arXiv:2504.12679, 2025a.

Chi Zhang, Zhao Yang, Jiaxuan Liu, Yanda Li, Yucheng Han, Xin Chen, Zebiao Huang, Bin Fu, and

Gang Yu. Appagent: Multimodal agents as smartphone users. In Proceedings of the 2025 CHI Conference on Human Factors in Computing Systems, pp. 1–20, 2025b.
...
Junlei Zhang, Zichen Ding, Chang Ma, Zijie Chen, Qiushi Sun, Zhenzhong Lan, and Junxian

He. Breaking the data barrier–building gui agents through task generalization. arXiv preprint arXiv:2504.10127, 2025c.
...
Tianyue Ou, Yonatan Bisk, Daniel Fried, et al. Webarena: A realistic web environment for building autonomous agents. arXiv preprint arXiv:2307.13854, 2023.
...
Tian, Weijie Su, Jie Shao, et al. Internvl3: Exploring advanced training and test-time recipes for open-source multimodal models. arXiv preprint arXiv:2504.10479, 2025.
...
Windows MacOS Linux iOS Android Web Avg Basic Adv. Basic Adv. Basic Adv. Basic Adv. Basic Adv. Basic Adv.
...
Agent Model Text Matching

Element Recognition

Layout Understanding

Fine-grained Manipulation Refusal Overall
...
ScaleCUA-3B 91.4 93.7 84.1 81.4 83.9 70.3 ScaleCUA-7B 93.3 93.1 86.0 86.3 84.3 74.8 ScaleCUA-32B 91.9 94.7 85.7 85.7 87.3 75.9 diminishes the agent’s propensity for active exploration within the environment, thereby degenerating its success rate in task completion.
...
MathVistaMINI (2023) OCRBench (2024b) MMMUvalid (2024) RealWorldQA (2024)
...
SeeClick (2024) Website 271K GUIEnv (2024a) Website 328K GUIAct (2024a) Website 67K WebUI (2023a) Website 57K Widget Captioning (2020b) Mobile 101K RicoSCA (2020a) Mobile 173K UI RefExp (2021) Mobile 16K RICO Icon (2017) Mobile 16K OmniACT (2024) Desktop & Website 7K UGround (2024)* Website 1404K OS-Atlas (2024b)* Desktop 799K JEDI (2025)* Desktop 550K Total – 3789K

Planning

MM-Mind2Web (2023) Website 7.8K GUIAct (2024a) Website 16.6K MiniWoB++ (2017) Website 9.9K AitZ (2024) Mobile 11.9K AndroidControl (2024a) Mobile 74.8K GUI Odyssey (2024a) Mobile 118.3K AMEX (2024) Mobile 35.6K AitW (2023) Mobile 19.0K PC Agent-E (2025) Desktop 27.8K Total – 321.7K
...
Action Platforms Description click(x, y, clicks, button) All Perform a mouse click at coordinates (x, y) using the specified button and number of clicks. write(message) All Input the given message. wait(seconds) All Pause execution for the specified number of seconds. response(answer) All Submit a response to the environment or task prompt. terminate(status) All Terminate the current task with a given completion status. scroll(clicks, x, y) Desktop Performs a scroll of the mouse scroll wheel at position (x, y). doubleClick(x, y, button) Desktop & Web Perform a double click at coordinates (x, y) with the specified button. rightClick(x, y, button) Desktop & Web Perform a right click at coordinates (x, y) with the specified button. hotkey(*args) Desktop & Web Trigger a keyboard shortcut composed of one or more keys. moveTo(x, y) Desktop & Web Move the mouse pointer to the specified (x, y) position. dragTo(x, y, button) Desktop & Web Drag the mouse to (x, y) while holding the specified button. press(keys, presses) Desktop & Web Press the specified key(s) a given number of times. keyDown(key) Desktop & Web Press and hold a key without releasing it. keyUp(key) Desktop & Web Release a previously held key. swipe(from, to, direction, amount) Mobile & Web Swipe from a start to end point in the specified direction with a given intensity or distance. navigate home() Mobile Return to the mobile home screen. navigate back() Mobile Navigate back to the previous screen on mobile. long press() Mobile Perform a long-press gesture on the current focus or location. open app(app name) Mobile Launch a mobile application by its name.
...
No files in the folder are selected for compression.

Agent repeats clicking the wrong spot without correction.
...
![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 26](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-026-figure-16.svg)
...
Attempt to restore without an image being selected.

Forgot to select the text need to change.
...
![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-16.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-17.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-19.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-20.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-22.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-48.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-49.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-50.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-51.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-52.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-53.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-54.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-55.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-56.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-57.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-58.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-59.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-60.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-61.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-62.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-63.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-64.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-65.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-66.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 27](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-027-figure-67.svg)
...
Agent subjectively chooses another item with reviews rather than the brush task needs.

Agent selects post for editing that not related to the “Star Trek Starfleet Academy” topic.
...
![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-19.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 28](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-028-figure-22.svg)
...
Grounding Bounding Box 1.6M 17.1M Point, Action
...
![Figure extracted from page 36](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-036-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 36](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-036-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 36](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-036-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 36](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-036-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 36](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-036-figure-05.svg)
...
![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 37](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-037-figure-15.svg)
...
[Point Grounding] Q: Return the point within this UI element: <ref>Preformatted Text button in the EDITOR tab’s formatting toolbar that allows users to insert pre-formatted text tags in MATLAB’s editor.</ref> A: <ref>Preformatted Text button in the EDITOR tab’s formatting toolbar that allows users to insert pre-formatted text tags in MATLAB’s editor.</ref><point>[[223, 45]]</point>

[Bbox Grounding] Q: Indicate the location with a bounding box to this UI element: <ref>A white-faced analog clock with black numerals (1-12) and three hands, placed in the upper left corner.<ref> A: <ref>A white-faced analog clock with black numerals (1-12) and three hands, placed in the upper left corner.<ref>>[[97, 69, 218, 227]]<bbox>

[Action Grounding] Q: Click the ’Open’ option to open the selected file A: <action>click(x=0.7983, y=0.4967) </action>
...
![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-20.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-22.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-23.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-24.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-25.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-26.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-27.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-28.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-29.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 38](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-038-figure-30.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

<!-- Page 39 -->

Technical Report collection. These trajectories span diverse applications such as Excel, SolidWorks, Gmail, Numbers, Amap, Twitter/X, and GitHub, showcasing real-world complexity in cross-platform environments. The visualizations highlight platform-specific GUI logic (e.g., desktop file operations vs. mobile touch navigation), as well as long-horizon reasoning steps (e.g., multi-page exploration, search-before-edit workflows).
...
![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-16.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-17.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-19.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-20.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-22.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-23.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-24.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-25.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-27.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-28.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-29.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-30.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-31.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-32.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-33.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-35.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-36.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-37.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-38.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-39.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-40.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 39](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-039-figure-41.svg)
...
![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-19.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-20.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-21.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-22.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-23.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-24.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-25.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-26.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-27.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-28.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-29.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-30.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-31.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-32.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 40](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-040-figure-33.svg)
...
![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-16.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-17.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-18.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 41](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-041-figure-19.svg)
...
![Figure extracted from page 42](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-042-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 42](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-042-figure-02.svg)
...
![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-06.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-07.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 43](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-043-figure-12.svg)
...
![Figure extracted from page 44](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-044-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 44](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-044-figure-02.svg)
...
![Figure extracted from page 46](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-046-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 46](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-046-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

<!-- Page 47 -->

Technical Report whose text, description, and value are all empty or punctuation. A role-aware merging process replaces overlapping AXStaticText siblings and their interactive parent with a minimal bounding box. The resulting set contains clean, tightly localised interactive elements. (see Fig. 26).
...
![Figure extracted from page 47](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-047-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 47](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-047-figure-02.svg)
...
![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-04.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-05.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-08.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-09.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-10.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-11.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-12.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-13.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-14.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-15.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-16.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-17.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 49](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-049-figure-18.svg)
...
x: float | None = None, y: float | None = None, clicks: int = 1, button: str = "left",) -> None:

"""Clicks on the screen at the specified coordinates. The `x` and `y` parameter specify where the mouse event occurs. If not provided, the current mouse position is used. The `clicks` parameter specifies how many times to click, and the `button` parameter specifies which mouse button to use ('left', 'right', or 'middle').""" pass def doubleClick( x: float | None = None, y: float | None = None, button: str = "left",) -> None:

"""Performs a double click. This is a wrapper function for click(x, y, 2, 'left').""" pass def rightClick(x: float | None = None, y: float | None = None) -> None:

"""Performs a right mouse button click. This is a wrapper function for click(x, y, 1, 'right').""" pass def moveTo(x: float, y: float) -> None:

"""Move the mouse to the specified coordinates.""" pass

<!-- Page 53 -->

Technical Report def dragTo( x: float | None = None, y: float | None = None, button: str = "left") -> None:

"""Performs a drag-to action with optional `x` and `y` coordinates and button.""" pass def swipe( from_coord: tuple[float, float] | None = None, to_coord: tuple[float, float] | None = None, direction: str = "up", amount: float = 0.5,) -> None:

"""Performs a swipe action on the screen. The `from_coord` and `to_coord` specify the starting and ending coordinates of the swipe. If `to_coord` is not provided, the `direction` and `amount` parameters are used to determine the swipe direction and distance. The `direction` can be 'up', 'down', 'left', or 'right', and the `amount` specifies how far to swipe relative to the screen size (0 to 1).""" pass def long_press(x: float, y: float, duration: int = 1) -> None:

"""Long press on the screen at the specified coordinates. The `duration` specifies how long to hold the press in seconds.""" pass

## Input Specification - Screenshot of the current screen + task description

## Output Format <action> [A set of executable action command] </action>

## Note - Avoid action(s) that would lead to invalid states. - The generated action(s) must exist within the defined action space. - The generated action(s) should be enclosed within <action></action> tags.
...
"""Performs a right mouse button click. This is a wrapper function for click(x, y, 1, 'right').""" pass

<!-- Page 54 -->

Technical Report def scroll(clicks: int, x: float | None = None, y: float | None = None) -> None:

"""Performs a scroll of the mouse scroll wheel at the specified coordinates. The `clicks` specifies how many clicks to scroll. The direction of the scroll (vertical or horizontal) depends on the underlying operating system. Normally, positive values scroll up, and negative values scroll down.""" pass def moveTo(x: float, y: float) -> None:

"""Move the mouse to the specified coordinates.""" pass def dragTo( x: float | None = None, y: float | None = None, button: str = "left") -> None:

"""Performs a drag-to action with optional `x` and `y` coordinates and button.""" pass def press(keys: str | list[str], presses: int = 1) -> None:

"""Performs a keyboard key press down, followed by a release. The function supports pressing a single key or a list of keys, multiple presses, and customizable intervals between presses.""" pass def hotkey(*args: str) -> None:

"""Performs key down presses on the arguments passed in order, then performs key releases in reverse order. This is used to simulate keyboard shortcuts (e.g., 'Ctrl-Shift-C').""" pass def keyDown(key: str) -> None:

"""Performs a keyboard key press without the release. This will put that key in a held down state.""" pass def keyUp(key: str) -> None:

"""Performs a keyboard key release (without the press down beforehand).""" pass def write(message: str) -> None:

"""Write the specified text.""" pass def call_user() -> None:

"""Call the user.""" pass def wait(seconds: int = 3) -> None:

"""Wait for the change to happen.""" pass def response(answer: str) -> None:

"""Answer a question or provide a response to an user query.""" pass def terminate(status: str = "success", info: str | None = None) -> None:

"""Terminate the current task with a status. The `status` specifies the termination status ('success', 'failure'), and the `info` can provide additional information about the termination.""" pass
...
## Note - Avoid action(s) that would lead to invalid states. - The generated action(s) must exist within the defined action space. - The generated operation and action(s) should be enclosed within <operation></operation> and <action></action> tags, respectively.
...
"""Performs a right mouse button click. This is a wrapper function for click(x, y, 1, 'right').""" pass def scroll(clicks: int, x: float | None = None, y: float | None = None) -> None:
...
## Note - Avoid actions that would lead to invalid states. - The generated action(s) must exist within the defined action space. - The reasoning process, operation and action(s) in your response should be enclosed within <think></think>, <operation></operation> and <action></action> tags, respectively
...
## Important Notes: - Do not copy or paraphrase the content of the A11Tree attributes directly.

<!-- Page 58 -->

Technical Report

- Please avoid using {marker} as part of your description. Because we draw {marker} for reference and they does not exist in the original screenshot. - Ensure each description is detailed enough to uniquely identify the element without ambiguity.

RETURN THE DICTIONARY IN STRICT JSON FORMAT:

Prompt For Screen Transition Captioning and User Intention Prediction

You are a GUI agent currently operating on a {os_name} device. You will be provided with: 1. The first image is a screenshot from an {application}, which are marked with {marker} to highlight the selected element.

2. The second image is the results of the operation {action} executed on the selected element. 3. The third image is a sub-image, which is cropped from the screenshot around the selected element and is marked with {marker}. 4. The A11Tree attributes of the selected element: {element_a11tree}.

Your task is to analyze these two consecutive screenshots and complete the following tasks: 1. **State Transition Explanation**: Describe the state change caused by the operation. This should include a detailed description of the first screenshot, the action performed on the element, the differences observed in the second screenshot compared to the first, and an explanation of the most likely user action that occurred between the two frames. 2. **User Intention Inference**: Based on the action performed and the differences between the two screenshots, infer the user's intent. Explain what the user likely aimed to achieve and how the action led to the observed changes in the GUI.
...
## Important Notes: - Avoid directly copying the A11Tree attributes of the element when writing instructions. - Ensure the instructions are clear, unambiguous, and concise, preferably described in a single sentence. - Do not reference the distinctive red indicator when describing UI elements.
...
You will be given the following information: 1. **Initial State Image**: A visual representation of the starting point of the interaction shown in the first image. 2. **Final State Image**: A visual representation of the endpoint of the interaction shown in the second image. 3. **Interaction Trajectory**: A detailed log of each step taken by the user, including the intent behind each action: {history}

Your task is to craft a concise summary (1-2 sentences) that describes the navigation journey by focusing on the goal and outcome. 1. **Identifies the user’s core objective**: - Emphasize the transition from the initial state to the final state (implicitly or explicitly). - Focus on the user's overall intent as inferred from the interaction history and the final state, avoiding overly detailed descriptions of operational steps (e.g., describe the task as "updating preferences" rather than "toggle the switch"). 2. **Highlights the functionality of the final state**: - Briefly describe the primary function of the final state, focusing on what the user can accomplish or access as a result of completing the navigation task.
...
- The phone is displaying Amap's app info page. My goal is to access the "My Guide" section on Amap's homepage from here. - To view Amap's notification permission, I want to move from Amap's homepage to system settings page for Amap. - Starting from Amap's battery usage settings, I need to reach the "Offline Maps" section in the app's main interface. - With the aim of saving posts in Instagram, please advance from the home screen to "Saved Posts" tab from Instagram's homepage.
...
You will be provided with: 1. The first image is a original screenshot from an {application}, which are manually marked to highlight the selected element. 2. The second image is the results of the operations `\`\`\`{action}`\`\`\` executed on the selected element. If the action is 'terminate', then the second image does not exist. 3. The third image is a sub-image cropped from the original screenshot, focusing on the selected element, which is highlighted with a red bounding box and arrow for better visibility. 4. The A11Tree attributes of the selected element: {element_a11tree}.

REMEBER: - Do NOT directly copying the A11Tree attributes of the selected elements as instructions. - Do NOT reference the distinctive red indicator when describing UI elements.
...
You will be provided with: 1. The first image is a original screenshot from an {application}, which are marked to highlight the selected element. 2. The second image is the results of the operations `\`\`\`{action}`\`\`\` executed on the selected element. If the action is 'terminate', then the second image does not exist. 3. The third image is a sub-image cropped from the original screenshot, focusing on the selected element for better visibility. 4. The A11Tree attributes of the selected element: {element_a11tree}. 5. The task objective is `{task_objective}` and history trace is `{history}`.

Guidelines: - Examine the selected UI element and relevant contextual features that support task completion, considering both the objective and interaction history. {marker} higlighted in image is manually added to assist in identifying elements and **should not** been mentioned. - Provide your reasoning in three sentences, ensuring alignment with the goal and labeled action, but do not cite the actual action or bounding box as justification, as these reflect hindsight rather than predictive insight. - Restrict your analysis to details from the first image only, and avoid referencing image order.
...
You are a helpful assistant to refine the given user instructions. The refined instructions should be clear, polite, and structured as a direct request or question, often including: - A specific action or configuration change. - Optional context or reasoning (e.g., "I want to ensure my browsing is private"). - A conversational yet concise tone

**Some Examples for reference:** - "Configure the system to show seconds in the taskbar clock." - "Can you configure VS Code to automatically check for updates on startup?" - "Could you assist me in cleaning up my computer by removing any tracking data that Chrome might have stored?" - "I want to hear something soft and beautiful music when Windows starts up. Can you set that MP3 file I like as my startup sound?" - "I don't want to see all these news on the home page of Microsoft Edge. Remove them in Page settings."
...
![Figure extracted from page 62](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-062-figure-01.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 62](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-062-figure-02.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 62](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-062-figure-03.svg)

AI-readable visual equivalent, added: Figure extracted from the paper PDF and converted to an SVG wrapper asset. Use the surrounding page text and caption for interpretation.

![Figure extracted from page 62](2026-ICLR-scalecua-scaling-open-source-computer-use-agents-with-cross-platform-data/page-062-figure-04.svg)
