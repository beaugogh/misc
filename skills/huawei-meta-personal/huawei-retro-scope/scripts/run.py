...
def main():
    ...
    # Adds task["llm_label"] — a natural-language category label generated by
    # a local LLM. Auto-detects ollama/llama-cpp/transformers. Silently skips
    # when no local LLM is available (rule-based classify_task stands alone).
    try:
