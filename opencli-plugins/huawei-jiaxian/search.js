...
cli({
    ...
    func: async (page, kwargs) => {
        ...
        const docs = await page.evaluate(async (selector, max) => {
            ...
            window.open = (u) => { if (u) opens.push(String(u)); return { focus() {}, close() {} }; };
            ...
            for (const card of nodes) {
                ...
                opens.length = 0;
                const inner = card.querySelector(".contention-page-content");
                inner?.click();
